...
<head>
    <meta charset="UTF-8">
    <title>星·光</title>
    <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/static/images/me.jpg" media="screen" />
    ...
    <style>
        ...
        *{
        ...
        #right{
            ...
            height: 300px;
            border: solid;
            background: url('/static/images/${photo.photoName }') no-repeat gray;
            background-size: cover;
        }
...
<div>
    ...
    <div id="bg" >
        <p>
            如果你想得到你从没有得到过的东西，你就必须做一些你从来就没有做过的事情。
            <br>
        </p>
    </div>
    <div id="left">
        <center><h4>公告：</h4></center>
        <span> &emsp;&emsp;${notice.notifydesc}</span>
    </div>
    <div id="right">
